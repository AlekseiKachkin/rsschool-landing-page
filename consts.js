...
export const burgerNav = document.getElementById('nav-burger');
export const HOR = document.getElementById('hor');
export const VER = document.getElementById('ver');
export const BODY = document.body;
export const WRAPPER = document.getElementById('wrapper')
export const SLIDER = document.getElementById('slider-container');
export const sliderLBtn = document.getElementById('controls-left');
export const sliderRBtn = document.getElementById('controls-right');
export const sliderSection = document.getElementById('Slider');
...
export const bestGiftsContainer = document.getElementById('best-gifts-container');
export const giftsSection = document.getElementById('Gifts');
export const giftsContainer = document.getElementById('gifts-container');
export const allTab = document.getElementById('All');
export const workTab = document.getElementById('Work');
export const healthTab = document.getElementById('Health');
export const harmonyTab = document.getElementById('Harmony');
